...
const DATABASE_CONNECTION_LIMIT = toPositiveInt(process.env.DATABASE_CONNECTION_LIMIT, 10);
const DATABASE_POOL_TIMEOUT_SECONDS = toPositiveInt(process.env.DATABASE_POOL_TIMEOUT_SECONDS, 10);
