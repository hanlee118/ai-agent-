...
export default function App() {
  ...
  return (
    <div className="shell-v2 studio-shell-root">
      <aside className="workspace-switcher studio-workspace-rail">
      ...
      <aside className="shell-sidebar-v2 studio-shell-sidebar">
        ...
        <header className="shell-topbar-v2 studio-topbar">
          ...
          <div className="shell-topbar-meta studio-topbar-actions">
            ...
            <div className="shell-topbar-popover" ref={shortcutPopoverRef}>
              ...
              {notificationsOpen ? (
                <div className="shell-shortcut-panel">
            ...
            <button className="workspace-icon-button" type="button" aria-label={copy.settings} onClick={() => navigate("/settings")}>
              <Settings size={18} />
            </button>
